...
///////////////////////////////////////////////////////////////////
  ...
  Int_t lhcbFont        = 42;  // Old LHCb style: 62;
  // Line thickness
  ...
  lhcbStyle->SetLegendFont(42);
  lhcbStyle->SetLegendFillColor(0);
  lhcbStyle->SetLegendTextSize(0.04);

  // If you want the usual gradient palette (blue -> red)
  //lhcbStyle->SetPalette(kSunset);
  //lhcbStyle->InvertPalette();
  ...
  lhcbStyle->SetPadRightMargin(0.03); // increase for colz plots
  ...
  lhcbStyle->SetLabelSize(0.85*lhcbTSize,"x");
  lhcbStyle->SetLabelSize(0.85*lhcbTSize,"y");
  lhcbStyle->SetLabelSize(0.85*lhcbTSize,"z");
  ...
  lhcbStyle->SetMarkerSize(0.07);

  // label offsets
  lhcbStyle->SetLabelOffset(0.010,"X");
  lhcbStyle->SetLabelOffset(0.014,"Y");
  lhcbStyle->SetLabelOffset(0.010,"Z");
  ...
  lhcbStyle->SetTitleOffset(0.05,"Z");
  ...
  lhcbStyle->SetTitleXOffset(0.86);
  lhcbStyle->SetTitleYOffset(1.4);
